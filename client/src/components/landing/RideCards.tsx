...
const FEATURED_RIDES: RideCardData[] = [
  ...
  },
  {
    ...
    driverCollege: 'USCS Computer Science · Final Yr',
    driverRating: 4.9,
    driverAvatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80',
    vehicle: 'Hyundai i20 (UK 07 AV 8112)',
    departureTime: '08:30 AM',
    origin: 'Suddhowala PG Corridor',
    destination: 'UU Campus Gate 1 (UIT)',
    fare: '₹35',
    seatsAvailable: 2,
